import{_ as t,r as p,o,c,a as s,b as l,w as r,F as i,d as a,e as n}from"./app.df2b219c.js";const u={},b=a(`<h1 id="api-reference" tabindex="-1"><a class="header-anchor" href="#api-reference" aria-hidden="true">#</a> API Reference</h1><h2 id="states" tabindex="-1"><a class="header-anchor" href="#states" aria-hidden="true">#</a> States</h2><h3 id="data-objects" tabindex="-1"><a class="header-anchor" href="#data-objects" aria-hidden="true">#</a> Data Objects</h3><p>The list of entities to be labeled.</p><p>The &quot;data objects&quot; state follows the <code>DataObjects</code> data structure as below.</p><div class="language-typescript ext-ts line-numbers-mode"><pre class="language-typescript"><code><span class="token keyword">type</span> <span class="token class-name">DataObject</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
